...
local Data_Monoid_monoidArray = {
  mempty = {},
  Semigroup0 = function() return Data_Semigroup_semigroupArray end
}
...
local Control_Monad_Writer_Trans_bindWriterT_S_w = function( dictSemigroup
, dictBind )
  local Apply0 = dictBind.Apply0()
  return {
    bind = function(v)
      return function(k)
        return dictBind.bind(v)(function(v1)
          return (Apply0.Functor0()).map(function(v3)
            return Data_Tuple_Tuple(v3.value0)(dictSemigroup.append(v1.value1)(v3.value1))
          end)(k(v1.value0))
        end)
      end
    end,
    Apply0 = function()
      return Control_Monad_Writer_Trans_applyWriterT_S_w(dictSemigroup, Apply0)
    end
  }
end
local Control_Monad_Writer_Trans_applicativeWriterT_S_w = function( dictMonoid
, dictApplicative )
  return {
    pure = function(a)
      return dictApplicative.pure(Data_Tuple_Tuple(a)(dictMonoid.mempty))
    end,
    Apply0 = function()
      return Control_Monad_Writer_Trans_applyWriterT_S_w(dictMonoid.Semigroup0(), dictApplicative.Apply0())
    end
  }
end
local Golden_LongWriterBind_Test_discard = (Control_Monad_Writer_Trans_bindWriterT_S_w(Data_Semigroup_semigroupArray, Data_Identity_bindIdentity)).bind
local Golden_LongWriterBind_Test_tell = (function()
  local dictMonad_S_511 = {
    Applicative0 = function() return Data_Identity_applicativeIdentity end,
    Bind1 = function() return Data_Identity_bindIdentity end
  }
  return function(x_S_532_S_535)
    return (dictMonad_S_511.Applicative0()).pure(Data_Tuple_Tuple(Data_Unit_foreign.unit)(x_S_532_S_535))
  end
end)()
local Golden_LongWriterBind_Test_go = (function()
  local _S_kont539 = Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
    [1] = 161
  }))(function()
                                                                            ...
                                                                            return Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
                                                                              ...
                                                                              return Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
                                                                                ...
                                                                                return Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
                                                                                  ...
                                                                                  return (Control_Monad_Writer_Trans_applicativeWriterT_S_w(Data_Monoid_monoidArray, Data_Identity_applicativeIdentity)).pure(42)
                                                                                end)
                                                                              end)
                                                                            end)
                                                                          end)
  ...
  local _S_kont540 = Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
    [1] = 121
  }))(function()
    return Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
      [1] = 122
  ...
  local _S_kont541 = Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
    [1] = 81
  }))(function()
    return Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
      [1] = 82
  ...
  local _S_kont542 = Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
    [1] = 41
  }))(function()
    return Golden_LongWriterBind_Test_discard(Golden_LongWriterBind_Test_tell({
      [1] = 42
