...
local Data_Either_append_S_w = function(s1_S_513_S_554, s2_S_514_S_555)
...
Control_Monad_Except_Trans_applyExceptT = function(dictMonad)
  return {
    apply = (function()
      local dictMonad_S_542 = Control_Monad_Except_Trans_monadExceptT(dictMonad)
...
Control_Monad_Except_Trans_applicativeExceptT = function(dictMonad)
  return {
    pure = function(x_S_575_S_588)
      return (dictMonad.Applicative0()).pure(Data_Either_Right(x_S_575_S_588))
    end,
    Apply0 = function()
      return Control_Monad_Except_Trans_applyExceptT(dictMonad)
    end
...
local Golden_LongExceptBind_Test_add_S_w = function( x_S_511_S_549
, y_S_512_S_550 )
...
local Golden_LongExceptBind_Test_go = (function()
  local _S_kont793 = function(x1_S_794)
    return function(x160_S_795)
      return Golden_LongExceptBind_Test_bind(Data_Either_Right(Golden_LongExceptBind_Test_add_S_w(x160_S_795, 1)))(function( x161 )
                                                                                ...
                                                                                return Golden_LongExceptBind_Test_bind(Data_Either_Right(Golden_LongExceptBind_Test_add_S_w(x197, 1)))(function( x198 )
                                                                                  return Golden_LongExceptBind_Test_bind(Data_Either_Right(Golden_LongExceptBind_Test_add_S_w(x198, 1)))(function( x199 )
                                                                                    return Golden_LongExceptBind_Test_bind(Data_Either_Right(Golden_LongExceptBind_Test_add_S_w(x199, 1)))(function( x200 )
                                                                                      return (Control_Monad_Except_Trans_applicativeExceptT(Data_Identity_monadIdentity)).pure(Golden_LongExceptBind_Test_add_S_w(x1_S_794, x200))
                                                                                    end)
                                                                                  end)
                                                                                end)
                                                                              end)
  ...
  local _S_kont796 = function(x1_S_797)
    return function(x120_S_798)
      return Golden_LongExceptBind_Test_bind(Data_Either_Right(Golden_LongExceptBind_Test_add_S_w(x120_S_798, 1)))(function( x121 )
  ...
  local _S_kont799 = function(x1_S_800)
    return function(x80_S_801)
      return Golden_LongExceptBind_Test_bind(Data_Either_Right(Golden_LongExceptBind_Test_add_S_w(x80_S_801, 1)))(function( x81 )
  ...
  local _S_kont802 = function(x1_S_803)
    return function(x40_S_804)
      return Golden_LongExceptBind_Test_bind(Data_Either_Right(Golden_LongExceptBind_Test_add_S_w(x40_S_804, 1)))(function( x41 )
