...
return (function()
  ...
  return Effect_Console_foreign.log(Data_Show_foreign.showIntImpl(M.Golden_FieldCaching_Test_apply2(function( y_S_247 )
    local Golden_FieldCaching_Test_weigh = M.Golden_FieldCaching_Test_weigh
    return Golden_FieldCaching_Test_weigh(5) + Golden_FieldCaching_Test_weigh(y_S_247)
  end)))()
end)()
